...
public class Receipie implements Parcelable {
    int id;
    private String name;
   ...
   private ArrayList<Steps> steps;
    ...
    public Receipie(JSONObject bake_jason) {
        try {
    ...
    public static final Creator<Receipie> CREATOR = new Creator<Receipie>() {
        @Override
        public Receipie createFromParcel(Parcel in) {
            return new Receipie(in);
        }

        @Override
        public Receipie[] newArray(int size) {
            return new Receipie[size];
        }
    };

    protected Receipie(Parcel in) {
        id = in.readInt();
