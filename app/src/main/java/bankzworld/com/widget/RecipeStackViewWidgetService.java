...
import bankzworld.com.pojo.Ingredient;
...
class StackViewsRemoteFactory implements RemoteViewsService.RemoteViewsFactory {
    private ArrayList<Receipie> mRecipes;
    ...
    public RemoteViews getViewAt(int position) {
        ...
        Receipie recipe = mRecipes.get(position);
    ...
    public void onDataSetChanged() {
        if(mRecipes == null) {
            ...
            try {
                ...
                Receipie[] recipeArray = new Gson().fromJson(reader, Receipie[].class);
